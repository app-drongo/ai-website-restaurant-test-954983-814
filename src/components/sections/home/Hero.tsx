...
const DEFAULT_HERO = {
  badge: 'New: Authentic Dining Experience',
  title: 'Savor exceptional flavors at',
  titleHighlight: 'Bella Vista Restaurant',
  description:
    'Experience culinary excellence with our chef-crafted dishes made from the finest local ingredients. Perfect for intimate dinners, celebrations, and memorable dining experiences.',
  features: [
  ...
  statsLabel1: 'Guest Rating',
  statsValue1: '4.9/5 Stars',
  statsLabel2: 'Experience',
  statsValue2: '15+ Years',
} as const;
