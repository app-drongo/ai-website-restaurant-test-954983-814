...
const DEFAULT_CONTACT = {
  badge: 'Contact Us',
  mainTitle: 'Get in Touch with',
  mainTitleHighlight: 'Bella Vista',
  mainDescription:
    "We'd love to hear from you. Whether you have questions about our menu, want to make a reservation, or need catering services, we're here to help.",
  formTitle: 'Send us a Message',
  formDescription: "Fill out the form below and we'll get back to you within 24 hours.",
  submitButton: 'Send Message',
  contactSectionTitle: 'Reach Out to Us',
  method1Title: 'Email Us',
  method1Description: 'Send us an email',
  method1Contact: 'info@bellavista.com',
  method2Title: 'Call Us',
  method2Description: 'Speak with our team',
  method2Contact: '+1 (555) 234-5678',
  method3Title: 'Reservations',
  method3Description: 'Book your table',
  method3Contact: 'Available online 24/7',
  officesSectionTitle: 'Visit Our Restaurant',
  office1City: 'Main Location',
  office1Address: '123 Culinary Street, Downtown',
  office1Timezone: 'EST (UTC-5)',
  office2City: 'Private Dining',
  office2Address: 'Same location, 2nd floor',
  office2Timezone: 'EST (UTC-5)',
  office3City: 'Catering Office',
  office3Address: '456 Event Avenue, Suite 200',
  office3Timezone: 'EST (UTC-5)',
  hoursTitle: 'Restaurant Hours',
  hoursWeekdayLabel: 'Monday - Thursday',
  hoursWeekdayTime: '5:00 PM - 10:00 PM',
  hoursSaturdayLabel: 'Friday - Saturday',
  hoursSaturdayTime: '5:00 PM - 11:00 PM',
  hoursSundayLabel: 'Sunday',
  hoursSundayTime: '4:00 PM - 9:00 PM',
  supportNote: 'Private dining and catering available with advance booking',
  nameLabel: 'Full Name *',
  namePlaceholder: 'Your Name',
  emailLabel: 'Email Address *',
  emailPlaceholder: 'your.email@example.com',
  companyLabel: 'Occasion (Optional)',
  companyPlaceholder: 'Birthday, Anniversary, Business Dinner...',
  messageLabel: 'Message *',
  messagePlaceholder:
    'Tell us about your reservation needs, dietary restrictions, or any questions...',
} as const;
