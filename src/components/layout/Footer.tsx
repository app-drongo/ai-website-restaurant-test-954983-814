...
const DEFAULT_FOOTER = {
  ...
  companyDescription:
    'Experience authentic Italian cuisine crafted with passion and the finest ingredients. Join our family for an unforgettable dining experience in the heart of the city.',
  contactEmail: 'info@bellavista.com',
  contactPhone: '+1 (555) 234-5678',
  contactAddress: '456 Culinary Street, Downtown',
  newsletterTitle: 'Stay Connected',
  newsletterPlaceholder: 'Your email address',
  newsletterDisclaimer:
    'Get updates on special events, seasonal menus, and exclusive offers. Unsubscribe anytime.',
  section1Title: 'Menu',
  section2Title: 'Experience',
